            ...
            <div className="products container">
                {
                    toys.map(toy => (
                        <div className='singeleProduct'>
                            ...
                            <button className='singeleProduct-delete-btn singeleProduct-btn text-danger me-4'>  <FontAwesomeIcon className='me-1' icon={faTrash} size='lg' color='gray'></FontAwesomeIcon>Delete</button>
